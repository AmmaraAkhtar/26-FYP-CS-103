...
// Chat Risk Cards
            ...
            Row(
              children: const [
                Text("Alerts", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                SizedBox(width: 5),
    ...
    return Container(
      ...
      child: Row(
        children: [
          const CircleAvatar(
            radius: 25,
            backgroundImage: NetworkImage('https://static.vecteezy.com/system/resources/previews/022/416/248/non_2x/avatar-of-girl-with-pigtails-colored-icon-vector.jpg'), // Avatar image
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text("Contact Name: $contactName", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                const Text("Tumha mana mar dana hy, mar dana hy", style: TextStyle(color: Colors.white, decoration: TextDecoration.underline, fontSize: 12)),
              ],
            ),
          ),
          Column(
            ...
            children: [
              const Text("Risk\nScore", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 10)),
              ...
              Container(
                ...
                child: Text(riskLevel, style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
              ),
            ],
          )
        ],
